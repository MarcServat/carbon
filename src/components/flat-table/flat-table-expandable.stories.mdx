...
<Canvas>
  <Story name="both parent and children selectable">
    {() => {
    ...
    {() => {
      ...
      const SubRows = [
        <FlatTableRow>
          ...
          />
          <FlatTableCell id={`ft-row--sub-row-1-cell-1`}>
            Child one
          </FlatTableCell>
        ...
        <FlatTableRow>
          <FlatTableCheckbox
            ...
            onChange={() => handleSelectRow("one")}
          />
          <FlatTableCell id={`ft-row--sub-row-2-cell-1`}>
            Child two
          </FlatTableCell>
          <FlatTableCell id={`ft-row--sub-row-2-cell-2`}>
            Edinburgh
          </FlatTableCell>
...
<Canvas>
  <Story name="sizes">
    {() => {
      ...
      return (
        <div>
          {["compact", "small", "medium", "large", "extraLarge"].map(
            (size, index) => (
              <Box mb={3} key={index}>
                <FlatTable size={size}>
                  <FlatTableHead>
